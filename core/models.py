...
class Category(models.Model):
    ...
    slug = models.SlugField(max_length=100, default='motherboard')
    ...
    def save(self, *args, **kwargs):
        ...
        if self.image and self.image.name != 'no_img.jpg':
            self.image = crop(self.image, length)
...
class Item(models.Model):
    ...
    description1 = models.TextField(max_length=50, blank=True, null=True)
    description2 = models.TextField(max_length=50, blank=True, null=True)
    description3 = models.TextField(max_length=50, blank=True, null=True)
    description4 = models.TextField(max_length=50, blank=True, null=True)
    description5 = models.TextField(max_length=50, blank=True, null=True)
    information = models.TextField()
    brand = models.TextField(max_length=10, default='Skade')
    image = models.ImageField(default='no_img.jpg')
    ...
    def save(self, *args, **kwargs):
        ...
        if self.image and self.image.name != 'no_img.jpg':
            self.image = crop(self.image, length)
        if self.img1 and self.img1.name != 'no_img.jpg':
            self.img1 = crop(self.img1, length)
        if self.img2 and self.img2.name != 'no_img.jpg':
            self.img2 = crop(self.img2, length)
        if self.img3 and self.img3.name != 'no_img.jpg':
            self.img3 = crop(self.img3, length)
        if self.img4 and self.img4.name != 'no_img.jpg':
            self.img4 = crop(self.img4, length)
        if self.img5 and self.img5.name != 'no_img.jpg':
            self.img5 = crop(self.img5, length)
        if self.a1 and self.a1.name != '':
            self.a1 = crop_a(self.a1, a_length)
        if self.a2 and self.a2.name != '':
            self.a2 = crop_a(self.a2, a_length)
        if self.a3 and self.a3.name != '':
            self.a3 = crop_a(self.a3, a_length)
        super(Item, self).save()
